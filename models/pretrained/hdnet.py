...
class HDNet(nn.Module):
    ...
    def __init__(self, in_ch=28, out_ch=28, conv=default_conv, pretrained_model_path = None):
        ...
        if pretrained_model_path != False:
            ...
            #checkpoint = torch.load(pretrained_model_path, map_location=device)['pretrained']
